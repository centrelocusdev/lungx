...
// ]
const options = [
  { value: JSON.stringify({id: 1,position: "Coarse crackle",isChecked: true}),  label: 'Coarse crackle' },
  { value: JSON.stringify({id: 2,position: "Fine crackle",isChecked: true}),  label: 'Fine crackle' },
  { value: JSON.stringify({id: 3,position: "Ronchi",isChecked: true}),  label: 'Ronchi' },
  { value: JSON.stringify({id: 4,position: "Wheeze",isChecked: true}),  label: 'Wheeze' },
  { value: JSON.stringify({id: 5,position: "Normal",isChecked: true}),  label: 'Normal' },
  { value: JSON.stringify({id: 6,position: "All",isChecked: true}),  label: 'All' },
]

// jugaad
const allValue = JSON.stringify([{id: 1,position: "Coarse crackle",isChecked: true},
...
let e = {target: {name:name1,value:JSON.stringify({id,position,optionid,options:flag?isAllChosen[posOfIsAllChosen]:newValue})}}
