        ...
        <div className="w-screen min-h-screen bg-[rgba(0,0,0,0.2)] backdrop-blur flex fixed justify-center items-center  p-8 md:p-0 ">
          ...
          {doctorsList?.length ? (
            ...
            <div  className="mt-20">
              ...
              <div style={{width: 100+'%'}} className="flex gap-2 justify-center items-center">
              ...
              <div  style={{width: 100+'%'}} className="flex gap-2 justify-around items-center">
              ...
              <div  style={{width: 100+'%'}} className="flex gap-2 justify-around items-center">
                <div style={{width: 90+'%'}} className="flex justify-start gap-2">
                <InputPrimaryAudioTag
                  name={'p6_tag'}
